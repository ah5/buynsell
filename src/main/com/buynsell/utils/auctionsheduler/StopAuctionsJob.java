...
public class StopAuctionsJob implements Job 
{
	public void execute(JobExecutionContext context) throws JobExecutionException
    {
    	...
    	for(int i=0; i<winningBids.size(); i++)
    	{
    		...
    		String subject="buyNsell Mailer Program : AUCTION TERMINATED !";
    		...
    		String contentAfterImage="</td></tr><tr><td colspan='100%'><font color='white'>YOUR BID HAS BEEN A WINNER IN OUR AUCTIONS</td></tr>"+
    				...
    				"</td><td></td><td></td></tr>"+
    				"<tr><td><font face='tahoma' size='2'><b>Auction id :</td><td><font face='tahoma' size='2'>"+bid.getAuctionid()+"</td>"+
					"<td><font face='tahoma' size='2'><b>Bid Price :</td><td><font face='tahoma' size='2'>"+bid.getBidprice()+"</td></tr>";
			if(bidDet.size() > 0)
    		{
    			String col="#E8E8E8";
    			for(int j=0; j<bidDet.size(); j++)
    			{
					...
					contentAfterImage=contentAfterImage+
						"<tr bgcolor='"+col+"'><td colspan='4'><hr></td></tr><tr bgcolor='"+col+"'>"+
						"<td><font face='tahoma' size='2'>Product Id :</td><td><font face='tahoma' size='2'>"+det.getProductid()+"</td>"+
						"<td><font face='tahoma' size='2'>Bid Qty :</td><td><font face='tahoma' size='2'>"+det.getBidqty()+"</td></tr>";
				}
    		}
    		contentAfterImage=contentAfterImage+
    	...
    	/*
    	 *find out the loosing bids also
    	 *then send corres mails to those users
    	 **/
