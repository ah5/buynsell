...
public class StartAuctionsJob implements Job
{
	public void execute(JobExecutionContext context) throws JobExecutionException
    {
    	...
    	String subject="buyNsell Mailer Program : NEW AUCTION ANNOUNCED !";
		...
		if(allProducts.size() > 0)
		{
			...
			for(int j=0; j<allProducts.size(); j++)
			{
				...
				contentAfterImage=contentAfterImage+
					...
					"<td><font face='tahoma' size='2'>Product Id :</td><td><font face='tahoma' size='2'>"+product.getProductid()+
					"</td><td></td><td></td></tr><tr bgcolor='"+col+"'>"+
		...
		contentAfterImage=contentAfterImage+
						...
						"to buyNsell and post your bids anytime you feel like ! <br>"+
		...
		contentAfterImage="</td></tr><tr><td colspan='100%'><font color='white'>FILLER</td></tr>"+
								"<tr><td colspan='100%' align='center'><font face='tahoma' size='2'>"+
								"Your auction has been announced to all the users of buyNsell !<br>"+
								"Thank You !</td></tr></table></body></html>";
