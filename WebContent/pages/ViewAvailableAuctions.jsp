...
<table>	
		<tr height="20"><td><img src="images/disp1.gif"></td><tr>
</table>
<br>
...
<%
	...
	ArrayList allCatalogs	=	JdbcData.loadCatalog(u.getUserid(), false);
	Catalog catalog=null;
	if(allCatalogs.size() > 0)
	{
%>
<html:form action="/SelectAuctionForBidding">
<%
					...
					<tr>
						<td align="right" colspan="4">
							...
							<html:radio property="auctionSelected" value="<%=catalog.getCatalogid()%>">
								<b>Select this Auction for Bidding
							</html:radio>
						</td>
					</tr>	
				</table><br>
...
%>
				<html:submit value="Start Bidding"/>
</html:form>			
<%
		}
		else
			...
			<table border-color='gray' border='1' rules='none' cellpadding='3' cellspacing='3' width='550' style='border-collapse: collapse'>
				<tr bgcolor='#B00000'>
					<td><font color='white' face='tahoma' size='2'>
						<b>No Auctions Currently Available
					</td>
				</tr>
			</table>
<%
